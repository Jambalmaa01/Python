...
const Plan = () => {
  return (
    <div className=' max-w-[1400px]  m-auto py-16  px-4 grid lg:grid-cols-2 gap-4 '>
        ...
        {/* left side */}
        <img className='row-span-2 object-cover w-full h-full p-2' src="https://images.unsplash.com/photo-1506929562872-bb421503ef21?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1368&q=80" alt="" />
    ...
    <div className=' flex flex-col h-full justify-center'>
        <h3 className='text-5xl mnd:text-6xlnfont-bold'>daraagiin ajil tolowlot</h3>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum voluptatibus assumenda quae illo dicta accusantium sint, libero odio soluta inventore?</p>
         <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum voluptatibus assumenda quae illo dicta accusantium sint, libero odio soluta inventore?</p>
        <p className='ph-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum voluptatibus assumenda quae illo dicta accusantium sint, libero odio soluta inventore?</p>
